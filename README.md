...
- **🖼️ 每日一画** — 50 幅公共领域中国山水画每日随机一张,8% 透明度水印点缀卡片
...
| DataStore Preferences | 1.2.1 | 主题 + 统计 + 背景开关 |
| Coil | 2.7.0 | 网络图片加载 |
| Gson | 2.11.0 | JSON 解析 |
| KSP | 2.3.8 | 代码生成 |
| AGP | 9.2.0 | 构建工具 |
...
- [x] Apache-2.0 许可证
- [x] 14 个 Lucide 风格本地矢量图标(替代 material-icons-extended)
- [x] 每日一张山水画水印(50 幅 The Met Museum 公共领域国画,8% 透明度)
- [x] 设置页手动开关(「远山背景」)
...
- **[Lucide](https://lucide.dev)** — 图标路径灵感(ISC License)
...
- **[The Metropolitan Museum of Art Open Access](https://www.metmuseum.org/about-the-met/policies-and-documents/open-access)** — 50 幅公共领域中国山水画来源(CC0)
